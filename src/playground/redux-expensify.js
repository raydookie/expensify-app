...
// Filter function to filter expenses based on selected filters
...
// store.dispatch(setStartDate(123456));
// store.dispatch(setEndDate(32561));
...
// console.log({ ...user, location: "philidelphia", age: 27 });
